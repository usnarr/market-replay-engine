...
were taken at. The first set was taken at `aae4206`, which is later than the rows it is
...
| Date | Commit | Change | Before | After | Profile |
|---|---|---|---|---|---|
| 2026-09-21 | (this commit) | M7: first benchmarks for the loser tree, the comparator, and Merger.Next | — | see below | [cpu](profiles/merge-cpu-aae4206.svg), [mem](profiles/merge-mem-aae4206.svg) |
...
| Date | Commit | Change | Before | After | Profile |
|---|---|---|---|---|---|
| 2026-09-19 | (this commit) | M2 baseline: record codec, reader access, blob decode, canonical hash | — | see below | [cpu](profiles/store-cpu-aae4206.svg), [mem](profiles/store-mem-aae4206.svg) |
...
| Date | Commit | Change | Before | After | Profile |
|---|---|---|---|---|---|
| 2026-09-21 | (this commit) | release-batching: cache releaseUntil so a run of records inside one window costs one clock read, not one per record | 13.14 ns/op | 1.542 ns/op | [cpu](profiles/fanout-cpu-aae4206.svg), [mem](profiles/fanout-mem-aae4206.svg) |
