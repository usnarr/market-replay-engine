...
| [`convert.md`](./convert.md) | The archive-tier converter: the canonical source Parquet schema, the venue partitioning policy, and what `cmd/convert` rejects rather than repairs. |
