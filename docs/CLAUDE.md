...
| [`convert.md`](./convert.md) | The archive-tier converter: the canonical source Parquet schema, the venue partitioning policy, snapshot epoch placement, byte-reproducible artifacts, and what `cmd/convert` rejects rather than repairs. |
